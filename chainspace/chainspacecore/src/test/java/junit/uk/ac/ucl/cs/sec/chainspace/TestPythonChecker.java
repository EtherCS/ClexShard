...
public class TestPythonChecker {
    @Test
    public void test_post_checker() throws Exception {
        JSONObject requestJson = new JSONObject(
            "{\"transaction\": {\"inputIDs\": [], \"methodID\": \"init\", \"parameters\": [], \"outputs\": [\"0\"], \"returns\": [], \"dependencies\": [], \"referenceInputIDs\": [], \"contractID\": \"addition\"}, \"store\": {}}"
        );
        TransactionForChecker transactionForChecker = TransactionPackager.makeTransactionForChecker(
            CSTransaction.fromJson(requestJson.getJSONObject("transaction")),
            Store.fromJson(requestJson.getJSONObject("store"))
        );
        Utils.makePostRequest(
                "http://127.0.0.1:11011/addition/init",
