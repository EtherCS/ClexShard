...
int main(int argc, char **argv)
{
	...
	stLocalAddr[0].sin_port   = htons(10012);
	stLocalAddr[0].sin_addr.s_addr = 0;
    stLocalAddr[1].sin_family = AF_INET;
	stLocalAddr[1].sin_port   = htons(10022);
	...
	send_para.stRemoteAddr[0].sin_port   = htons(10011);
	...
	send_para.stRemoteAddr[1].sin_port   = htons(10021);
